...
launch: function(){
	...
	Aicl.Util.setUrlApi(location.protocol + '//' + location.host + '/dlfn-api');
	Aicl.Util.setHttpUrlApi(location.protocol + '//' + location.host + '/dlfn-api'+'/json/asynconeway')
		
	Aicl.Util.setUrlLogin(location.protocol + '//' + location.host + '/dlfn-api/login');
	Aicl.Util.setUrlLogout(location.protocol + '//' + location.host + '/dlfn-api/logout');
